...
# Diccionario tipo impacto con ponderación oculta y justificación
impactos = {
    "H": {"desc": "Afecta la vida, salud o seguridad de las personas.", "ponderacion": 100},
    "A": {"desc": "Puede causar daños irreversibles y sanciones graves.", "ponderacion": 85},
    "E": {"desc": "Pérdidas financieras que afectan la viabilidad.", "ponderacion": 80},
    "O": {"desc": "Interrupciones en procesos críticos.", "ponderacion": 75},
    "I": {"desc": "Daños a instalaciones o estructuras físicas.", "ponderacion": 65},
    "T": {"desc": "Fallas tecnológicas o ciberataques.", "ponderacion": 60},
    "R": {"desc": "Afecta la imagen pública o confianza institucional.", "ponderacion": 50},
    "S": {"desc": "Impacta comunidades o relaciones sociales.", "ponderacion": 45},
    "C": {"desc": "Pérdida de clientes o mercado (recuperable).", "ponderacion": 40},
}
...
# Layout principal: 3 columnas arriba
...
with col_centro:
    ...
    opciones_impacto_visibles = [f"{k} - {impactos[k]['desc']}" for k in impactos]
    seleccion_impacto = st.selectbox("Tipo de Impacto", opciones_impacto_visibles)
    codigo_impacto = seleccion_impacto.split(" - ")[0]
    st.markdown(f"**Justificación:** {impactos[codigo_impacto]['desc']}")
    ponderacion_impacto = impactos[codigo_impacto]["ponderacion"]
